...
| Input Field | Valid Equivalence Classes | Invalid Equivalence Classes |
|-------------|---------------------------|----------------------------|
| Password    | Length 8 to 20 characters  | Length < 8 or > 20 characters |
| Password    | Contains at least one uppercase letter, one lowercase letter, and one digit  | Does not contain the required letters and/or digit |
